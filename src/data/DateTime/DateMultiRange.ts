...
const DateMultiRange: MultiRangeConstructor<Date, DateObject> = getMultiRange<
	Date,
	DateObject
>(DateRange, DateRange.isRange, "DateMultiRange");

types.setTypeParser(DataType.datemultirange as any, parser(DateMultiRange));
types.setTypeParser(
	DataType._datemultirange as any,
	arrayParser(DateMultiRange)
);
